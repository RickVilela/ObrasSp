...
<head>
  ...
  <title>Obras SP - Detalhes dos Serviços</title>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="services-list">
              <a id="pintura" class="active">Pintura</a>
              <a id="materiais">Materias</a>
              <a id="arquitetura">Arquitetura</a>
              <a id="alvenaria">Alvenaria</a>
              <a id="eletrica">Elétrica</a>
              <a id="ferramentas">Ferramentas</a>
            </div>
          </div>
