      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Bem-vindo a <span>OBRAS SP</span></h2>
            <p data-aos="fade-up">Confira já os nossos parceiros e realize sua obra da melhor forma!</p>
            <a data-aos="fade-up" data-aos-delay="200" href="#comecar" class="btn-get-started">Começar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Dicas</h2>
          <p>Confira já as melhores dicas para a sua Obra!</p>
        </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <h3>Pintura</h3>
              <p>O serviço de pintura desempenha um papel fundamental na estética e na proteção de ambientes residenciais, comerciais e industriais.</p>
              <a href="service-details.php" class="readmore stretched-link">Ler mais <i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h3>Materiais</h3>
              <p>A utilização de bons materiais na construção é de extrema importância, pois eles desempenham um papel fundamental na qualidade, durabilidade e segurança de qualquer estrutura.</p>
              <a href="service-details.php" class="readmore stretched-link">Ler mais <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <h3>Arquitetura</h3>
              <p>Um bom arquiteto desempenha um papel fundamental em qualquer projeto de construção ou design de espaços.</p>
              <a href="service-details.php" class="readmore stretched-link">Ler mais <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <h3>Alvenaria</h3>
              <p>A boa alvenaria desempenha um papel fundamental na construção de estruturas sólidas e duradouras.</p>
              <a href="service-details.php" class="readmore stretched-link">Ler mais <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item position-relative">
              ...
              <h3>Elétrica</h3>
              <p>Uma boa instalação elétrica desempenha um papel crucial na construção civil.</p>
              <a href="service-details.php" class="readmore stretched-link">Ler mais <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <h3>Ferramentas</h3>
              <p>Utilizar boas ferramentas na construção civil é de extrema importância, pois elas desempenham um papel fundamental na qualidade, eficiência e segurança do trabalho. </p>
              <a href="service-details.php" class="readmore stretched-link">Ler mais <i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
    ...
    <section id="projects" class="projects">
          <section id="recent-blog-posts" class="recent-blog-posts">
            <div class="container" data-aos="fade-up">
              ...
              <div class="parceiro-card row gy-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <h3>OBRAS SP</h3>
              <p>
                Rua Antonio de Castro, 710 <br>
                Limeira 13482-020, BR<br><br>
                <strong>Phone:</strong> (19) 99635-8015<br>
                <strong>Email:</strong> contato@ntzcontainers.com.br<br>
              </p>
